...
import type { AuthType } from "@flowright/shared"
      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Configure an app URL and auth for crawling and running tests</p>
          </div>
        </div>
